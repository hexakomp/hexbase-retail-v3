...
echo "==> Running central-only migrations..."
php artisan migrate --force --path=database/migrations/central

echo "==> Running tenant migrations for demo tenant..."
TENANT_DB_DATABASE=hexbase_tenant_demo php artisan migrate --force \
